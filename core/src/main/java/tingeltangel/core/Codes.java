...
import tingeltangel.core.constants.CodePreferenceConstants;
...
public class Codes {
    ...
    */
    ...
    public static void loadProperties() {
        setPatternSize600(Properties.getIntegerProperty(CodePreferenceConstants.PROPERTY_PATTERN_SIZE_600));
        setDotSize600(Properties.getIntegerProperty(CodePreferenceConstants.PROPERTY_DOT_SIZE_600));
        setDeltaSize600(Properties.getIntegerProperty(CodePreferenceConstants.PROPERTY_DELTA_SIZE_600));
        setPatternSize1200(Properties.getIntegerProperty(CodePreferenceConstants.PROPERTY_PATTERN_SIZE_1200));
        setDotSize1200(Properties.getIntegerProperty(CodePreferenceConstants.PROPERTY_DOT_SIZE_1200));
        setDeltaSize1200(Properties.getIntegerProperty(CodePreferenceConstants.PROPERTY_DELTA_SIZE_1200));
    }

    public static void saveProperties() {
        Properties.setProperty(CodePreferenceConstants.PROPERTY_PATTERN_SIZE_600, getPatternSize600());
        Properties.setProperty(CodePreferenceConstants.PROPERTY_DOT_SIZE_600, getDotSize600());
        Properties.setProperty(CodePreferenceConstants.PROPERTY_DELTA_SIZE_600, getDeltaSize600());
        Properties.setProperty(CodePreferenceConstants.PROPERTY_PATTERN_SIZE_1200, getPatternSize1200());
        Properties.setProperty(CodePreferenceConstants.PROPERTY_DOT_SIZE_1200, getDotSize1200());
        Properties.setProperty(CodePreferenceConstants.PROPERTY_DELTA_SIZE_1200, getDeltaSize1200());
    }
